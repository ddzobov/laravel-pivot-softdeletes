...
namespace DDZobov\PivotSoftDeletes\Tests\Integration\Database\EloquentBelongsToManyTest;
...
class EloquentBelongsToManyTest extends DatabaseTestCase
{
    ...
    {
        $this->expectException(ModelNotFoundException::class);
        $this->expectExceptionMessage('No query results for model [DDZobov\PivotSoftDeletes\Tests\Integration\Database\EloquentBelongsToManyTest\Tag] 10');
    ...
    {
        $this->expectException(ModelNotFoundException::class);
        $this->expectExceptionMessage('No query results for model [DDZobov\PivotSoftDeletes\Tests\Integration\Database\EloquentBelongsToManyTest\Tag] 10, 11');
