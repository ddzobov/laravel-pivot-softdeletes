 ...
 * @group integration
 */
class EloquentBelongsToManySoftTest extends DatabaseTestCase
{
    ...
    public function testBasicCreateAndRetrieve()
    {
        ...
        $this->assertInstanceOf(EloquentPivot::class, $post->tags[0]->pivot);
    ...
    public function testForceDetachMethod()
    {
        ...
        $post->tags()->forceDetach([$tag->id, $tag3->id]);
    ...
    public function testSyncWithForceDetachingMethod()
    {
        ...
        $post->tags()->syncWithForceDetaching([$tag->id, $tag3->id]);
